...
export const NotesCanvas = forwardRef<NotesCanvasHandle, NotesCanvasProps>(function NotesCanvas(
  ...
  return (
    ...
    >
      ...
      {debugHoldDetection && (
        <div className="pointer-events-none absolute bottom-2 left-2 z-40 max-h-[70vh] overflow-y-auto rounded-lg bg-black/80 px-3 py-2 font-mono text-[11px] leading-relaxed text-white">
