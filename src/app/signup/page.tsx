...
export default function SignupPage() {
  ...
  if (checkEmail) {
    return (
      <div className="mx-auto flex min-h-[80vh] w-full max-w-sm flex-col justify-center px-4 py-16 text-center">
        <p className="mb-2 text-xs font-medium uppercase tracking-[0.2em] text-accent-dark">
          Distill
        </p>
    ...
    <div className="mx-auto flex min-h-[80vh] w-full max-w-sm flex-col justify-center px-4 py-16">
      ...
      >
        ...
        <input
          ...
          className="mb-1 w-full rounded-xl border border-border bg-background-alt p-3 text-sm text-foreground focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent-light"
        />
